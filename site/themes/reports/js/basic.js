$(document).ready(function(){
	...
	$('#save').button({icons:{primary:"ui-icon-disk"}}).click(function(evt){
		...
		var content = '<!DOCTYPE html><html><head>' + $('head').html() +
            '</head><body><h1>SEO Report <span class="by-author">by <a href="http://simple-seo-api.com">simple-seo-api.com</a></span></h1><div id="all-content">' + $('#all-content').html() + '</div></body></html>';
